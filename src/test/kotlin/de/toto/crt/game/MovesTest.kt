...
class MovesTest {
    ...
    fun pawnPossibleMoves() {
        ...
        // from start rank
        assertTrue(Pos("pe7", "Ke1", "ke8").movesFrom("e7").equal("e6", "e5"))
        // normal "one move"
        assertTrue(Pos("pe6", "Ke1", "ke8").movesFrom("e6").equal("e5"))
        // blocked
        assertTrue(Pos("pe3", "Re2", "Ke1", "ke8").movesFrom("e3").isEmpty())
        // pinned - can capture
        assertTrue(Pos("Bc6", "Ke1", "ke8", "pd7").movesFrom("d7").equal("c6"))
        // pinned
        assertTrue(Pos("Bb5", "Ke1", "ke8", "pd7").movesFrom("d7").isEmpty())
        // captures
        assertTrue(Pos("pe7", "ke8", "Ke1","Pd6", "Pf6").movesFrom("e7").equal("e6", "e5", "d6", "f6"))
    }
